	...
	<div class=" flex items-center justify-between pb-6">
		...
		<div class="flex items-center justify-between">
            ...
            <div class="flex bg-gray-50 items-center p-2 rounded-md">
                      ...
                      <select wire:model="orderBy" class="form-select form-select-lg
                        appearance-none
                        block
                        w-full
                        px-4
			...
			<div class="flex bg-gray-50 items-center p-2 rounded-md">
				...
				<input class="bg-gray-50 outline-none ml-1 block " type="text" wire:model="query" id="" placeholder="search...">
                <p class="px-4" wire:model="resultCount">{{ $resultCount }}</p>
          </div>
				<div class="lg:ml-40 ml-10 space-x-8">
					<a href="{{ route('admin.products.create') }}"><button class="bg-indigo-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">Create New Product</button></a>
				...
				<div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
					<table class="min-w-full leading-normal">
						...
						<tbody>
                            ...
                            @empty
                            <tr>
								<td class="flex items-center" colspan="5">
									No products yet...
								</td>
                            </tr>
                            @endforelse

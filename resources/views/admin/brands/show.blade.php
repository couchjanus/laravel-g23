<x-admin-layout>
    ...
    <div class="h-screen bg-indigo-100 flex justify-center items-center">
        <div class="w-full">
            <form class="bg-white p-10 rounded-lg shadow-lg min-w-full" method="POST" action="{{ route('brands.destroy', $brand->id) }}">
                @csrf
                @method('DELETE')
                <h1 class="text-center text-2xl mb-6 text-gray-600 font-bold font-sans">Show brand</h1>
                <div>
                ...
                <div>
                    ...
                    <input class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none" type="text"
                        name="description" id="name"  value="{{ $brand->description }}">
                </div>
                <hr class="mt-4">
                <div class="flex flex-row-reverse p-3">
                    ...
                    <div class="flex-initial">
                        <button type="submit"
                            ...
                            <span class="pl-2 mx-1">Delete Brand</span>
                        </button>
                    </div>
                </div>
        </div>
